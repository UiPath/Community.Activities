...
namespace UiPath.Python.Activities.Properties {
    ...
    public class UiPath_Python_Activities {
        ...
        /// <summary>
        ///   Looks up a localized string similar to When enabled, stdout and stderr output from the Python host process are forwarded to Robot tracing after the scope is initialized..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Log Python Traces.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Maximum size in MB of the data passed to the Python script as method arguments.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Payload Threshold (MB) must be at least 1 (1 MB minimum)..
        /// </summary>
