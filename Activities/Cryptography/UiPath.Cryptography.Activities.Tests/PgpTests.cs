...
{
    public class PgpTests : IDisposable
    {
        ...
        public PgpTests()
        {
            _publicKeyPath = Path.Combine(Path.GetTempPath(), $"pgp_test_public_{Guid.NewGuid()}.asc");
            _privateKeyPath = Path.Combine(Path.GetTempPath(), $"pgp_test_private_{Guid.NewGuid()}.asc");
