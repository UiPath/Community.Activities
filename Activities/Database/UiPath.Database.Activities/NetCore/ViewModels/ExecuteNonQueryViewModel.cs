...
namespace UiPath.Database.Activities
{
    ...
    /// </summary>
    [ViewModelClass(typeof(ExecuteNonQueryViewModel))]
...
{
    public partial class ExecuteNonQueryViewModel : DesignPropertiesViewModel
    {
        /// <summary>
        /// Basic constructor
        /// </summary>
        /// <param name="services"></param>
        public ExecuteNonQueryViewModel(IDesignServices services) : base(services)
        {
        }
