...
namespace UiPath.FTP.Activities.NetCore.ViewModels
{
    internal class DownloadFilesViewModel : BaseFtpViewModel
    {
        ...
        protected override void InitializeModel()
        {
            ...
            RemotePath.DisplayName = Resources.Activity_DownloadFiles_Property_RemotePath_Name;
            RemotePath.Tooltip = Resources.Activity_DownloadFiles_Property_RemotePath_Description;
            RemotePath.EditPlaceholder = Resources.Activity_DownloadFiles_Property_RemotePath_Placeholder;
            RemotePath.IsRequired = true;
            RemotePath.IsPrincipal = true;
            RemotePath.OrderIndex = orderIndex++;
            RemotePath.Category = Resources.Input;

            LocalPath.DisplayName = Resources.Activity_DownloadFiles_Property_LocalPath_Name;
            LocalPath.Tooltip = Resources.Activity_DownloadFiles_Property_LocalPath_Description;
            LocalPath.EditPlaceholder = Resources.Activity_DownloadFiles_Property_LocalPath_Placeholder;
            LocalPath.IsRequired = true;
            LocalPath.IsPrincipal = true;
            LocalPath.OrderIndex = orderIndex++;
            LocalPath.Category = Resources.Input;

            Create.DisplayName = Resources.Activity_DownloadFiles_Property_Create_Name;
            Create.Tooltip = Resources.Activity_DownloadFiles_Property_Create_Description;
            ...
            Recursive.DisplayName = Resources.Activity_DownloadFiles_Property_Recursive_Name;
            Recursive.Tooltip = Resources.Activity_DownloadFiles_Property_Recursive_Description;
            ...
            Overwrite.DisplayName = Resources.Activity_DownloadFiles_Property_Overwrite_Name;
            Overwrite.Tooltip = Resources.Activity_DownloadFiles_Property_Overwrite_Description;
