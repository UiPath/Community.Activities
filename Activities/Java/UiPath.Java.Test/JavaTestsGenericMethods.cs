...
namespace UiPath.Java.Test
{
    ...
    public class JavaTestsGenericMethods : IClassFixture<JavaTestDerivedFixture>
    {
        ...
        public async Task GenericMethodsConstructor_WithParams()
        {
            ...
            var javaObject = await _invoker.InvokeConstructor("uipath.java.test.GenericMethods", objParam, null, _ct);
            Assert.StartsWith("uipath.java.test.GenericMethods", javaObject.Convert<string>());

            //verifying the parameter using the property
            var javaMethod = await _invoker.InvokeMethod("getMessage", null, javaObject, null, null, _ct);
        ...
        public async Task GenericMethodsStringArray()
        {
            ...
            var javaMethod = await _invoker.InvokeMethod("GenericMethods", null, javaObject, new List<object> { Strings }, new List<Type> { typeof(string) }, _ct);
            Assert.Equal(Strings, javaMethod.Convert<string[]>());


            String[] EmptyStrings = { };

            var javaMethodEmpty = await _invoker.InvokeMethod("GenericMethods", null, javaObject, new List<object> { EmptyStrings }, new List<Type> { typeof(string) }, _ct);
            Assert.Equal(EmptyStrings, javaMethodEmpty.Convert<string[]>());
            Assert.False(javaMethodEmpty.IsNull());
            String[] NullStrings = null;

            var javaMethodNull = await _invoker.InvokeMethod("GenericMethods", null, javaObject, new List<object> { NullStrings }, new List<Type> { typeof(string[]) }, _ct);
            Assert.True(javaMethodNull.IsNull());
        }
        ...
        {      
            ...
            var javaMethod = await _invoker.InvokeMethod("GenericMethods", null, javaObject, new List<object> { objparam1, objparam2 }, new List<Type> { typeof(string), typeof(string) }, _ct);
        ...
        public async Task GenericMethodsIntArray()
        {
            ...
            var javaMethod = await _invoker.InvokeMethod("IntArr", null, javaObject, new List<object> { intArray }, null, _ct);
        ...
        public async Task FloatType()
        {
            ...
            var objFloatMethod = await _invoker.InvokeMethod("FloatType", "uipath.java.test.GenericMethods", null, objParmFloat, null, _ct);
        ...
        public async Task GenericsExtendString()
        {
            ...
            var stringObj = await _invoker.InvokeMethod("GenericsExtString", null, javaObject, new List<object> { testString }, new List<Type> { typeof(string) }, _ct);
        ...
        public async Task StringArrStatic()
        {
            ...
            var stringObj = await _invoker.InvokeMethod("StringArrStatic", "uipath.java.test.GenericMethods", null, new List<object> { testString }, new List<Type> { typeof(string) }, _ct);
        ...
        public async Task IntType()
        {
            ...
            var objInttMethod = await _invoker.InvokeMethod("IntType", "uipath.java.test.GenericMethods", null, intParm, null, _ct);
        ...
        public async Task BoolType()
        {
            ...
            var objInttMethod = await _invoker.InvokeMethod("BoolType", "uipath.java.test.GenericMethods", null, boolParm, null, _ct);
        ...
        public async Task GenericsExtObj1()
        {
            ...
            var stringObj2 = await _invoker.InvokeMethod("GenericsExtObj", null, javaObject, new List<object> { "test string" }, null, _ct);
        ...
        public async Task GenericsExtObj2()
        {
            ...
            var stringObj2 = await _invoker.InvokeMethod("GenericsExtObj", null, javaObject, new List<object> { floatobj }, null, _ct);
        ...
        public async Task Finalize()
        {
            ...
            var JOFinalize = await _invoker.InvokeMethod("finalize", null, javaObject, null, null, _ct);
        ...
        public async Task GenericsR_String()
        {
            ...
            var stringObj = await _invoker.InvokeMethod("GenericsR", null, javaObject, new List<object> { objParam }, null, _ct);
        ...
        public async Task GenericsR_integer()
        {
            ...
            var intObj = await _invoker.InvokeMethod("GenericsR", null, javaObject, new List<object> { 100 }, new List<Type> { typeof(int) }, _ct);
        ...
        public async Task GenericsR_Double()
        {
            ...
            var doubleObj = await _invoker.InvokeMethod("GenericsR", null, javaObject, new List<object> { objParam }, null, _ct);
        ...
        public async Task ConcatenateXYZ()
        {
            ...
            var javaMethod = await _invoker.InvokeMethod("ConcatenateXYZ", null, javaObject, null, null, _ct);
        ...
        public async Task RecursiveCallTestNotStatic()
        {
            ...
            var intObj = await _invoker.InvokeMethod("RecursiveCallTest", null, javaObject, new List<object> { objParam }, null, _ct);
        ...
        public async Task RecursiveCallTestStatic()
        {
            ...
            var intObj = await _invoker.InvokeMethod("StaticRecursiveCallTest", "uipath.java.test.GenericMethods", null, objParam, null, _ct);
